...
const Logo = require("../assets/imgs/logo_redondo.png");
const LogoPeq = require("../assets/imgs/logo_redondo_peq.png");
const LogoOnboarding = require("../assets/imgs/logo_redondo.png");
const ProfileBackground = require("../assets/imgs/profile-screen-bg.png");
const RegisterBackground = require("../assets/imgs/register-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const ArgonLogo = require("../assets/imgs/logo_redondo.png");
const iOSLogo = require("../assets/imgs/ios.png");
const androidLogo = require("../assets/imgs/android.png");
const fondoOnboard = require("../assets/imgs/fondo_full.png");
